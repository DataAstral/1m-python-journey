...
- Using `if` and `else` to make simple decisions  
- Comparing numbers with `>=`  
- Working with user input and type conversion using `int()`  

---

### [d06 — Mood Checker](./d06_if_elif_else_mood_checker)

- Using `if`, `elif`, and `else`  
- Responding differently based on user input  
- Building simple multi-branch logic  

---

### [d06 — Multiple Cases](./d06_conditions_multiple_cases)

- Handling several outcomes in one program  
- Checking fixed values like status codes  
- Using `else` as a fallback for unknown cases  

---

### [d06 — Conditions & Logical Operators](./d06_conditions_and_logical_operators)

- Combining conditions with:
  - `and`
  - `not`  
- Building simple access control logic  
- Checking multiple rules in one decision  

---

### [d07 — Conditions with `and` / `or`](./d07_conditions_and_logical_operators)

- Combining conditions with:
  - `and`
  - `or`  
- Using grouped logic with parentheses  
- Granting access based on multiple requirements  

---

### [d07 — Travel Check with `and`](./d07_conditions_and_logical_operators_and)

- Using `and` to require two true conditions  
- Checking passport and visa status  
- Building strict all-rules-must-pass logic  

---

### [d07 — Exam Check with Input](./d07_conditions_and_logical_operators_and_input)

- Combining user input with logical operators  
- Normalizing text with `.lower()`  
- Validating two conditions at the same time  

---

### [d07 — Logical Precedence](./d07_logical_operators_precedence)

- Understanding operator precedence in Python  
- Using parentheses to control evaluation  
- Combining `and` and `or` in more complex conditions  

---

### [d08 — Nested Discount System](./d08_nested_conditions_discount_system)

- Writing nested `if` statements  
- Checking one condition inside another  
- Creating multi-level decision logic  

---

### [d08 — Nested Login Check](./d08_nested_conditions_with_input)

- Using nested conditions with user input  
- Validating username and password step by step  
- Normalizing input with `.lower()`  

---

### [d08 — Nested Security System](./d08_nested_conditions_with_input_system)

- Building 3-level nested condition logic  
- Converting answers into boolean values  
- Creating full access / partial access / denied flows  
...
- [x] `if / elif / else` branching  
- [x] Multiple case handling  
- [x] Logical operators  
